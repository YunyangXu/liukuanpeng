...
class AlertWindowPage(StaticLayoutWindow):
  ...
  def __init__(self):
    ...
    super(AlertWindowPage, self).__init__(False, True, 0, 0, self.windowWidth, 
  ...
  def renderWindow(self):
    ...
    icon = QPixmap()
    icon.load(staticPath + '/icons/alert.png')
    ...
    self.confirmBtn.setObjectName('cancelBtn')
    self.confirmBtn.setCursor(Qt.PointingHandCursor)
    self.confirmBtn.clicked.connect(self.closeWindow)
